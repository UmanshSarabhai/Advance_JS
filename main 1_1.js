var jsonString = [{
    ...
    },
    {
        ...
        "region": "The North",
        "note": "Greyjoy's troop number comes from the 264 estimate to have arrived on the stony shore minus the 20 Theon takes to attack Winterfell. Thus 264-20=244"
    },
    {
        ...
        "location": "Winterfell",
        "region": "The North",
        "note": "It isn't mentioned how many Stark men are left in Winterfell, other than \"very few\"."
    },
    {
    ...
    },
    {
        ...
        "location": "Winterfell",
        "region": "The North",
        "note": "Since House Bolton betrays the Starks for House Lannister, we code this battle as between these two houses. Greyjoy men, numbering only 20, don't play a major part in the fighting and end up dying anyway."
    },
    {
    ...
    },
    {
        ...
        "attacker_size": 20000,
        "defender_size": 10000,
        "attacker_commander": "Tywin Lannister, Flement Brax, Gregor Clegane, Addam Marbrand, Lyle Crakehall, Leo Lefford",
    ...
    },
    {
        ...
        "location": "The Twins",
        "region": "The Riverlands",
        "note": "This observation refers to the battle against the Stark men, not the attack on the wedding"
    },
    {
    ...
    },
    {
        ...
        "defender_size": 1240,
        "attacker_commander": "Mance Rayder, Tormund Giantsbane, Harma Dogshead, Magnar Styr, Varamyr",
...
jsonString.forEach(function(item) {
    rez[item.attacker_king] ? rez[item.attacker_king]++ : rez[item.attacker_king] = 1;
});
//console.log(rez);

var rez1 = {};
jsonString.forEach(function(item) {
    rez1[item.defender_king] ? rez1[item.defender_king]++ : rez1[item.defender_king] = 1;
});
//console.log(rez1);

var rez2 = {};
jsonString.forEach(function(item) {
    rez2[item.region] ? rez2[item.region]++ : rez2[item.region] = 1;
});
//console.log(rez2);

var rez3 = {};
jsonString.forEach(function(item) {
    rez3[item.name] ? rez3[item.name]++ : rez3[item.name] = 1;
});
//console.log(rez3);



var numWins = jsonString.reduce(function(n, jsonString) {
    return n + (jsonString.attacker_outcome == 'win');
}, 0);
var numLoss = jsonString.reduce(function(n, jsonString) {
    return n + (jsonString.attacker_outcome == 'loss');
}, 0);
//console.log("Total no. of wins:" + numWins)
//console.log("Total no. of loss:" + numLoss);


let unique = [...new Set(jsonString.map(item => item.battle_type))];
//console.log("battle_types: " + unique);


jsonString.sort(function(a, b) {
    return a.defender_size - b.defender_size;
});
//console.log("Min defender_size: " + jsonString[19].defender_size) //first 18 elements has null defender_size
//console.log("Max defender_size: " + jsonString[jsonString.length - 1].defender_size)
...
//console.log("The average of defender_size: " + findAverageAge(jsonString));


console.log('most active:')
console.log('attacker_king: Joffrey/Tommen Baratheon: 14');
console.log('defender_king: Robb Stark: 14');
console.log('region: The Riverlands: 17');
console.log('All the name occurs only once');
console.log('attacker_outcome:');
console.log('wins: ' + numWins);
console.log('loss: ' + numLoss);
console.log('battle_type: ' + unique);
console.log('defender_size: ');
console.log('average: ' + findAverageAge(jsonString));
console.log('min: ' + jsonString[19].defender_size) //first 18 elements has null defender_size)
console.log('max: ' + jsonString[jsonString.length - 1].defender_size);